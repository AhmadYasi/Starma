...
def load_analysis_results():
    ...
    files_to_load = {
        'descriptive_stats': '../../report/output/tables/descriptive_statistics_overall.csv',
        'correlation_matrix': '../../report/output/tables/correlation_matrix.csv',
        'hypothesis_tests': '../../report/output/tables/hypothesis_test_results_corrected.csv',
        'confidence_intervals': '../../report/output/tables/confidence_intervals.csv',
        'cluster_characteristics': '../../report/output/tables/cluster_characteristics.csv',
        'suspicious_patterns': '../../report/output/tables/suspicious_patterns_analysis.csv',
        'classification_results': '../../report/output/tables/classification_results.csv',
        'feature_importance': '../../report/output/tables/feature_importance_best_model.csv',
        'journal_predictions': '../../report/output/tables/journal_predictions.csv',
        'publisher_analysis': '../../report/output/tables/publisher_analysis.csv'
    }
